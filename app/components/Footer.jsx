...
function Footer() {
  return (
    <footer className="md:place-items-none grid place-items-center bg-black px-8 py-14 md:grid-cols-2 md:grid-rows-2  md:px-10 lg:grid-cols-3 lg:grid-rows-2 lg:px-[170px] lg:py-[64px]">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="170"
        height="16"
        className="mb-8 md:col-start-1 md:row-start-1 md:mb-0 md:justify-self-start lg:self-start"
      >
        <defs>
      ...
      {/* footer nav menu  */}
      <div className="mb-[120px] md:col-start-1 md:row-start-2 md:mb-[72px] md:justify-self-start lg:col-start-2  lg:row-span-2 lg:mb-0">
        <FooterMenu />
      </div>
      {/* get invite / arrow  */}
      <div className="mb-[34px] px-[69px] md:col-start-2 md:row-start-1 md:mb-0 md:justify-self-end md:px-0 lg:col-start-3 lg:row-start-1 lg:self-start">
        <LinkArrow
          linkText="get invite"
      ...
      {/* Copyright notice */}
      <div className="text-[15px] font-normal text-white/50 md:col-start-2 md:row-start-3 md:justify-self-end lg:col-start-3 lg:row-start-2 lg:self-end ">
